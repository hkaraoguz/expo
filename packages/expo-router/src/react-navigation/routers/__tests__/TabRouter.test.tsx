...
test('falls back to the first surviving route in declared order', () => {
  const router = TabRouter({});
  const options: RouterConfigOptions = {
    routeNames: ['qux', 'bar'],
    routeParamList: {},
  ...
  expect(result.routes[result.index!]!.name).toBe('qux');
});

test('rehydration falls back to the first surviving route in declared order', () => {
  const router = TabRouter({});
  const options: RouterConfigOptions = {
    routeNames: ['qux', 'bar'],
    routeParamList: {},
